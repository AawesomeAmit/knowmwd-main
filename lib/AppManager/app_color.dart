...
class AppColor {
   static Color primaryColor =  const Color.fromRGBO(15, 50, 106, 1);
   ...
   static Color greyLighter = '#F8FAFE'.toColor();
   static Color customBlue = const Color.fromRGBO(87, 96, 117,1);
   static Color orangeButtonColor = '#FFC114'.toColor();
   static Color orangeHeading = '#ffaf16'.toColor();
