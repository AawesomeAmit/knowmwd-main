                            ...
                            CommonWidgets().showNoData(
                                ...
                                child: Expanded(
                                  child: StaggeredGridView.countBuilder(
                                    crossAxisCount: 4,
                                    itemCount: modal.controller.questionList
                                        .isEmpty ?
                                    5 :
                                    modal.controller.getQuestionList.length,
                                    // modal.controller.getQuestionList.length,
                                    itemBuilder: (context, index) {
                                      ResponseValue1 questionList = modal
                                          .controller.getQuestionList.isEmpty ?
                                      ResponseValue1(
                                          id: 0,
                                          question: '',
                                          description: '',
                                                    ...
                                                    Column(
                                                      children: [
                                                        questionList
                                                            .isBookmarked == 1
                                                            ? SvgPicture.asset(
                                                            'assets/bookmark1.svg')
                                                            :
                                                        SvgPicture.asset(
                                                            'assets/bookmark2.svg'),
                                                      ],
                                                    )
                                                  ],
                                                ),
