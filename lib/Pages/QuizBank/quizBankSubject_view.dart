...
class QuizBankSubjectView extends StatefulWidget {
  const QuizBankSubjectView({Key? key}) : super(key: key);

  @override
  _QuizBankSubjectViewState createState() => _QuizBankSubjectViewState();
}

class _QuizBankSubjectViewState extends State<QuizBankSubjectView> {
